...
async function main() {
  ...
  const caseSkinsMap = {
    'dreams-nightmares': [
      'M4A1-S | Blue Phosphor','P250 | See Ya Later','MAG-7 | Monster Call','Nova | Windblown',
      'XM1014 | Zombie Offensive','Five-SeveN | Hyper Beast','MP9 | Starlight Protector','MAC-10 | Pipe Down',
      'AK-47 | Redline','AWP | Atheris','AWP | Asiimov','Glock-18 | Fade',
      'USP-S | Kill Confirmed','Desert Eagle | Blaze','CZ75-Auto | Tigris','MP9 | Wild Lily',
      'MP7 | Bloodsport','AK-47 | Neon Revolution','M4A4 | Neo-Noir','AK-47 | Bloodsport',
      'AWP | Chromatic Aberration','M4A1-S | Emphorosaur-S','AK-47 | X-Ray','Glock-18 | Wasteland Rebel',
      'PP-Bizon | Embargo','Nova | Toy Soldier','Sawed-Off | Kiss♥Love','MAG-7 | SWAG-7',
      'AK-47 | Head Shot','P250 | Exchanger','Glock-18 | Neo-Noir',
    ],
    'recoil': [
      'AK-47 | Redline','AK-47 | Vulcan','USP-S | Kill Confirmed','M4A4 | Spider Lily',
      'AWP | Hyper Beast','USP-S | Orion','AWP | Fade','AK-47 | Slate',
      'Glock-18 | Fade','Desert Eagle | Blaze','M4A1-S | Master Piece','AK-47 | Nightwish',
      'AWP | Asiimov','M4A1-S | Hyper Beast','AK-47 | Neon Revolution','MP7 | Bloodsport',
      'MAG-7 | SWAG-7','CZ75-Auto | Tigris','P2000 | Ocean Foam','AK-47 | Bloodsport',
      'AWP | Chromatic Aberration','Glock-18 | Neo-Noir','AK-47 | Head Shot','USP-S | Printstream',
      'Desert Eagle | Printstream','MP5-SD | Phosphor','PP-Bizon | Embargo','Five-SeveN | Hyper Beast',
      'AK-47 | X-Ray','P250 | Exchanger','Nova | Toy Soldier',
    ],
    'revolution': [
      'AK-47 | Asiimov','AK-47 | Neon Revolution','AWP | Asiimov','M4A1-S | Blue Phosphor',
      'Glock-18 | Fade','USP-S | Kill Confirmed','Desert Eagle | Blaze','MP9 | Wild Lily',
      'AK-47 | Redline','M4A4 | Neo-Noir','AWP | Wildfire','M4A4 | The Emperor',
      'AK-47 | Vulcan','AWP | Duality','M4A1-S | Printstream','USP-S | Printstream',
      'Desert Eagle | Fennec Fox','CZ75-Auto | Tigris','AK-47 | Jaguar','AWP | Hyper Beast',
      'M4A1-S | Welcome to the Jungle','AK-47 | Bloodsport','AK-47 | Head Shot','Glock-18 | Neo-Noir',
      'P250 | Exchanger','MP5-SD | Phosphor','MAC-10 | Neon Rider','AK-47 | X-Ray',
      'AWP | Exoskeleton','AK-47 | Slate','PP-Bizon | Embargo',
    ],
    'kilowatt': [
      'AK-47 | Nightwish','M4A4 | Etch Lord','P250 | Exchanger','AWP | Exoskeleton',
      'AK-47 | Redline','AWP | Asiimov','Glock-18 | Fade','Desert Eagle | Blaze',
      'M4A1-S | Hyper Beast','USP-S | Kill Confirmed','AK-47 | Vulcan','MP9 | Wild Lily',
      'M4A4 | Neo-Noir','AWP | Wildfire','AK-47 | Bloodsport','CZ75-Auto | Tigris',
      'AK-47 | Neon Revolution','M4A1-S | Blue Phosphor','Desert Eagle | Printstream','AWP | Hyper Beast',
      'USP-S | Printstream','AK-47 | Jaguar','MAC-10 | Neon Rider','AK-47 | Head Shot',
      'Glock-18 | Neo-Noir','MP5-SD | Phosphor','AK-47 | X-Ray','AWP | Chromatic Aberration',
      'AK-47 | Slate','Nova | Toy Soldier','MAG-7 | SWAG-7',
    ],
    'snakebite': [
      'Desert Eagle | Fennec Fox','AK-47 | Head Shot','M4A1-S | Emphorosaur-S','AWP | Atheris',
      'AK-47 | Redline','Glock-18 | Fade','USP-S | Kill Confirmed','Desert Eagle | Blaze',
      'MP9 | Wild Lily','M4A4 | Neo-Noir','AK-47 | Neon Revolution','AWP | Asiimov',
      'CZ75-Auto | Tigris','AK-47 | Bloodsport','M4A1-S | Hyper Beast','AWP | Chromatic Aberration',
      'USP-S | Orion','AK-47 | Jaguar','MP7 | Bloodsport','Glock-18 | Wasteland Rebel',
      'P250 | See Ya Later','AK-47 | X-Ray','AK-47 | Slate','PP-Bizon | Embargo',
      'MAC-10 | Pipe Down','MP9 | Starlight Protector','Nova | Toy Soldier','MAG-7 | SWAG-7',
      'Five-SeveN | Hyper Beast','P250 | Exchanger','Glock-18 | Neo-Noir',
    ],
    'riptide': [
      'AWP | Containment Breach','P2000 | Ocean Foam','MAC-10 | Pipe Down','AK-47 | Bloodsport',
      'AWP | Asiimov','AK-47 | Redline','Glock-18 | Fade','USP-S | Kill Confirmed',
      'Desert Eagle | Blaze','MP9 | Wild Lily','M4A4 | Neo-Noir','AK-47 | Neon Revolution',
      'CZ75-Auto | Tigris','M4A1-S | Hyper Beast','AWP | Hyper Beast','AK-47 | Vulcan',
      'USP-S | Printstream','Desert Eagle | Printstream','AK-47 | Jaguar','AK-47 | Head Shot',
      'MP5-SD | Phosphor','AK-47 | X-Ray','Glock-18 | Neo-Noir','AWP | Chromatic Aberration',
      'AK-47 | Slate','PP-Bizon | Embargo','MP9 | Starlight Protector','MAG-7 | SWAG-7',
      'Nova | Toy Soldier','Five-SeveN | Hyper Beast','P250 | Exchanger',
    ],
    'fracture': [
      'M4A1-S | Printstream','USP-S | Printstream','Desert Eagle | Printstream','AK-47 | Jaguar',
      'Sawed-Off | Kiss♥Love','Nova | Toy Soldier','AWP | Wildfire','M4A1-S | Welcome to the Jungle',
      'AK-47 | Redline','AWP | Asiimov','Glock-18 | Fade','USP-S | Kill Confirmed',
      'Desert Eagle | Blaze','MP9 | Wild Lily','M4A4 | Neo-Noir','AK-47 | Neon Revolution',
      'CZ75-Auto | Tigris','M4A1-S | Hyper Beast','AK-47 | Bloodsport','AWP | Silk Tiger',
      'Glock-18 | Wasteland Rebel','AK-47 | Head Shot','AWP | Chromatic Aberration','AK-47 | X-Ray',
      'MP5-SD | Phosphor','MAC-10 | Neon Rider','UMP-45 | Primal Saber','PP-Bizon | Embargo',
      'AK-47 | Slate','P250 | Exchanger','Glock-18 | Neo-Noir',
    ],
    'prisma-2': [
      'AK-47 | Fuel Injector','AK-47 | Point Disarray','AK-47 | X-Ray','MP5-SD | Phosphor',
      'M4A4 | Desolate Space','AWP | Chromatic Aberration','AK-47 | Redline','Glock-18 | Fade',
      'USP-S | Kill Confirmed','Desert Eagle | Blaze','AWP | Asiimov','MP9 | Wild Lily',
      'M4A4 | Neo-Noir','CZ75-Auto | Tigris','M4A1-S | Hyper Beast','AK-47 | Neon Revolution',
      'AK-47 | Bloodsport','MAC-10 | Neon Rider','UMP-45 | Primal Saber','Glock-18 | Neo-Noir',
      'P2000 | Ocean Foam','AK-47 | Head Shot','AWP | Silk Tiger','AK-47 | Slate',
      'PP-Bizon | Embargo','MP9 | Starlight Protector','MAC-10 | Pipe Down','Five-SeveN | Hyper Beast',
      'P250 | Exchanger','Nova | Toy Soldier','MAG-7 | SWAG-7',
    ],
    'ancient': [
      'AK-47 | Wild Lotus','AWP | The Prince','M4A4 | The Emperor','AWP | Duality',
      'AK-47 | Redline','AWP | Asiimov','Glock-18 | Fade','USP-S | Kill Confirmed',
      'Desert Eagle | Blaze','MP9 | Wild Lily','M4A4 | Neo-Noir','AK-47 | Neon Revolution',
      'CZ75-Auto | Tigris','M4A1-S | Hyper Beast','AK-47 | Vulcan','AWP | Hyper Beast',
      'PP-Bizon | Embargo','MAC-10 | Neon Rider','AK-47 | Bloodsport','Glock-18 | Neo-Noir',
      'USP-S | Printstream','Desert Eagle | Printstream','AK-47 | Jaguar','AK-47 | Head Shot',
      'AWP | Chromatic Aberration','AK-47 | X-Ray','AK-47 | Slate','MP5-SD | Phosphor',
      'P250 | Exchanger','Nova | Toy Soldier','MAG-7 | SWAG-7',
    ],
    'clutch': [
      'AK-47 | The Empress','M4A1-S | Master Piece','M4A4 | Neo-Noir','Glock-18 | Neo-Noir',
      'AWP | Neo-Noir','USP-S | Orion','AK-47 | Redline','AWP | Asiimov',
      'Glock-18 | Fade','USP-S | Kill Confirmed','Desert Eagle | Blaze','MP9 | Wild Lily',
      'CZ75-Auto | Tigris','M4A1-S | Hyper Beast','AK-47 | Neon Revolution','AK-47 | Bloodsport',
      'AWP | Hyper Beast','AK-47 | Vulcan','Desert Eagle | Printstream','USP-S | Printstream',
      'AK-47 | Jaguar','MAC-10 | Neon Rider','MP5-SD | Phosphor','AK-47 | Head Shot',
      'AWP | Chromatic Aberration','AK-47 | X-Ray','AK-47 | Slate','PP-Bizon | Embargo',
      'P250 | Exchanger','Five-SeveN | Hyper Beast','Nova | Toy Soldier',
    ],
  };
